    ...
    if (status == 0) {
        ...
        if (item != null) {
            ...
            if (im.getItemQuantity(2431893) >= amount) {
                im.sendYesNo("您现在持有#r" + im.getItemQuantity(2431893) + "#k个#b#i2431893:# #t2431893##k \r\n您要用#r" + amount + "个#k#t2431893#交换#i" + itemId + ":# #b#t" + itemId + "##k 吗？");
            } else {
                im.sendOk("兑换#i" + itemId + ":# #b#t" + itemId + "##k需要#r" + amount + "个#k#b#t2431893##k\r\n您还需收集#r" + (amount - im.getItemQuantity(2431893)) + "#k个我才能为您兑换。");
                im.dispose();
            }
        } else {
            im.sendOk("出现错误...");
