...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (cm.getJob() % 10 == 2 && cm.getJob() != 2002 && cm.getJob() != 3002 && cm.getJob() != 4002 || cm.getJob() == 2217) { //四转结束
			if (cm.isQuestFinished(1465)) {
				cm.dispose();
				cm.openNpc(1530635, "quickchang5job");
			} else {
				if (cm.getLevel() < 200) {
			...
			if (cm.getJob() % 1000 == 0 || cm.getJob() == 0 || cm.getJob() == 4001 || cm.getJob() == 4002 || cm.getJob() == 3000 || cm.getJob() == 2001 || cm.getJob() == 2002 || cm.getJob() == 2003 || cm.getJob() == 2004 || cm.getJob() == 2005 || cm.getJob() == 2000 || cm.getJob() == 6001 || cm.getJob() == 3001 || cm.getJob() == 3002) {
				if (cm.getPlayerStat("LVL") == 8 || cm.getPlayerStat("LVL") == 9) { //如果是法师
					...
					if (cm.getJob() == 2000) {
						...
						for (var i = 0; i < jobData.length; i++) {
							if ((jobData[i][1] % 100 == 0) && (jobData[i][1] > cm.getJob()) && (jobData[i][1] < (600 + cm.getJob()) && jobData[i][1] > (100 + cm.getJob()) || jobData[i][1] == (700 + cm.getJob()))) {
								advance += "\r\n#b#L" + jobData[i][1] + "#" + jobData[i][0] + "#l";
							} else if (cm.getJob() == 0 & jobData[i][1] % 100 == 0 && (jobData[i][1] > cm.getJob()) && (jobData[i][1] < (600 + cm.getJob()) || jobData[i][1] == (700 + cm.getJob()))) {
								advance += "\r\n#b#L" + jobData[i][1] + "#" + jobData[i][0] + "#l";
							}
						}
					}
			...
			} else if (cm.getJob() % 10 == 0 || cm.getJob() % 10 == 1 || cm.getJob() == 3120 || cm.getJob() == 3121 || cm.getJob() == 2214) { // 第三次\4次转职
