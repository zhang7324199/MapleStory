                ...
                if (cm.getParty() != null) {
                    if (cm.getDisconnected("BossQuestEASY") != null) {
                        ...
                        if (next) {
                            ...
                            cm.sendOk("所有的组队成员必学在70级以上.");
                        }
                    } else {
                        cm.sendOk("你不是组队长，请让组队长与我对话。.");
                    }
                } else {
                    cm.sendOk("请先创建一个队伍！.");
                }
