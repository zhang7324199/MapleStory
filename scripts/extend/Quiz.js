...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            var text = "我是饱读诗书的孔明，答题时间为每时#r" + startTime + "-" + endTime + "分#n#k,请准备：#b\r\n";
            ...
            if (selection == 2) {
                ...
                if (minute >= startTime && minute <= endTime) {
                    ...
                    cm.sendOk("当前服务器时间:" + hour + "点" + minute + "分\r\n时间还没到哦.整点的" + startTime + "-" + endTime + "分可以答题，例如:\r\n#b1点" + startTime + "分至1点" + endTime + "分\r\n#r而且可以答题的时候，系统会公告，请不要错过。");
                    cm.dispose();
                }
            }
            if (selection == 3) {
            ...
            if (typed == 1) {
                ...
                if (selection == tknow[5] || fee == tknow[5]) {
                    ...
                    var randred = Math.floor(Math.random() * 5) + 5;//枫叶
                    cm.setPQLog("答题正确");
                    if (randx < 3) {//冒险币
                        cm.gainMeso(randy);
                        cm.sendOk("恭喜，您答对了！#b 正确答案:" + tknow[5] + "#k\r\n您获得了 " + randy + " 冒险币.");
//                        cm.worldSpouseMessage(0x8, "[答题系统]：恭喜 " + cm.getChar().getName() + " 正确回答<诸葛孔明>的问题~得到 " + randy + " 冒险币~");
                    }
                    if (randx >= 3 && randx < 6) {//
                        cm.gainNX(2, randdj);
                        cm.sendOk("恭喜，您答对了！#b正确答案:" + tknow[5] + "#k\r\n您获得了 " + randdj + "抵用卷.");
//                        cm.worldSpouseMessage(0x8, "[答题系统]：恭喜 " + cm.getChar().getName() + " 正确回答<诸葛孔明>的问题,得到 " + randdj + " 抵用卷~");
                    }
                    if (randx >= 6 && randx < 9) {//
                        cm.gainNX(1, randdy);
                        cm.sendOk("恭喜，您答对了！#b正确答案:" + tknow[5] + "#k\r\n您获得了 " + randdy + " 点卷");
                        cm.worldSpouseMessage(0x8, "[答题系统]：恭喜 " + cm.getChar().getName() + " 正确回答<诸葛孔明>的问题,得到 " + randdy + " 点卷~");
                    }
                    if (randx >= 9 && randx <= 12) {//
                        //cm.gainPlayerPoints(randjf);
                        cm.gainItem(5072000, randjf);
//                        cm.sendOk("恭喜，您答对了！#b正确答案:" + tknow[5] + "#k\r\n您获得了 " + randjf + " 高质地喇叭.");
//                        cm.worldSpouseMessage(0x8, "[答题系统]：恭喜 " + cm.getChar().getName() + " 正确回答<诸葛孔明>的问题,得到 " + randjf + " 高质地喇叭~");
                    }
//                    if (randx >= 12 && randx <= 15) {//枫叶
//                        cm.gainItem(4001126, randred);
//                        cm.sendOk("恭喜，您答对了！#b正确答案:" + tknow[5] + "#k\r\n您获得了 " + randred + " 枫叶.");
//                        cm.worldSpouseMessage(0x8, "[答题系统]：恭喜 " + cm.getChar().getName() + " 正确回答<诸葛孔明>的问题,得到 " + randred + " 枫叶~");
//                    }
                    status = -1;
                    return;
                } else {
            ...
            if (typed == 2) {
                if (selection == 1) {//换取6个魔方和3个防爆卷轴
                    if (cm.getPQLog("答题128兑换") < 1) {
                        ...
                        cm.worldSpouseMessage(0x8, "[答题系统]:恭喜[" + cm.getChar().getName() + "]用正确答题数目兑换了大量魔方和卷轴~");
                    } else {
                    ...
                    cm.worldSpouseMessage(0x8, "[答题系统]:恭喜[" + cm.getChar().getName() + "]用正确答题数目兑换了答题高手勋章~");
                    ...
                    cm.worldSpouseMessage(0x8, "[答题系统]:恭喜[" + cm.getChar().getName() + "]用正确答题数目兑换了周年庆100%武器攻击卷轴箱子~");
                    ...
                    cm.worldSpouseMessage(0x8, "[答题系统]:恭喜[" + cm.getChar().getName() + "]用正确答题数目兑换了150级武器箱子~");
                }
                cm.dispose();
                return;
            }
