...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        txt += "　#b※ 并且保证两者数量 [ #r500#b ] 个 #r所有怪都有爆率#b　※#k#n\r\n　#b※ #r万能传送 - 快速练级 - 大蘑菇 （#g蓝蜗牛 可爆#b）#b ※\r\n\r\n";
        txt += "　#b※ 当前拥有#z4001231#数量：\t\t\t　#r" + cm.itemQuantity(4001231) + " / 500 个#b\r\n";
        txt += "　#b※ 当前拥有#z4001395#数量：\t\t#r" + cm.itemQuantity(4001395) + " / 500 个#b\r\n";
        ...
        if (selection == 0) {
            ...
            txt += "　#b※ 如玩家提供的数量正确　将领到  #r20000#b　 点卷　　※#k#n\r\n\r\n";
            txt += "#d┗━━━━━━━━━━━━━━━━━━━━━━━━━┛#k\r\n\r\n";
            cm.sendYesNoS(txt, 2);
        } else if (selection == 1) {
            if (cm.getEventCount("快乐圣诞") > 0) {
            ...
            if (cm.haveItem(4001231, 500) && cm.haveItem(4001395, 500)) {
                ...
                cm.setEventCount("圣诞点卷", 1, 20000);
                cm.forceCompleteQuest(22222);
                cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n　尊敬的玩家恭喜你\r\n\r\n已完成快乐圣诞 - 领点卷 [ 20000 ]");
                cm.worldSpouseMessage(0x01, "※ 快乐圣诞 ※ : 恭喜玩家[ " + cm.getPlayer().getName() + " ]完成 快乐圣诞 并获得 20000 点卷 ●ω●");
                cm.dispose();
            } else {
                cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n　尊敬的玩家非常抱歉\r\n\r\n你的道具不齐全 请检查道具数量");
                cm.dispose();
