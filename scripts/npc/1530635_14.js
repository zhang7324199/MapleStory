...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			selStr += "#L1##b" + aaa + " 第一天登录奖励 #v5062000# #rx 20#b [详情点击查看]#l#k\r\n";
			selStr += "#L2##b" + aaa + " 第二天登录奖励 #v5062002# #rx 20#b [详情点击查看]#l#k\r\n";
			selStr += "#L3##b" + aaa + " 第三天登录奖励 #v5062500# #rx 20#b[详情点击查看]#l#k\r\n";
			selStr += "#L4##b" + aaa + " 第四天登录奖励 #v5062009# #rx 10#b [详情点击查看]#l#k\r\n";
			selStr += "#L5##b" + aaa + " 第五天登录奖励 #v5062010# #rx 10#b [详情点击查看]#l#k\r\n";
			...
			if (typed == 1) {
				if (cm.getSpace(4) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 360 && cm.getLevel() >= 140) {
					...
					if (cm.getBossLogAcc("登录") == -1 && cm.getBossLogAcc("第一天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第一天登录奖励。");
						cm.dispose();
					} else {
				...
				if (cm.getSpace(5) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 160) {
					...
					if (cm.getBossLogAcc("登录") == -2 && cm.getBossLogAcc("第二天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第二天登录奖励。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
				...
				if (cm.getSpace(5) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 180) {
					...
					if (cm.getBossLogAcc("登录") == -3 && cm.getBossLogAcc("第三天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第三天登录奖励。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
				...
				if (cm.getSpace(5) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 180) {
					...
					if (cm.getBossLogAcc("登录") == -4 && cm.getBossLogAcc("第四天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第四天登录奖励。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
				...
				if (cm.getSpace(5) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 180) {
					...
					if (cm.getBossLogAcc("登录") == -5 && cm.getBossLogAcc("第五天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第五天登录奖励。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
				...
				if (cm.getSpace(2) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 200) {
					...
					if (cm.getBossLogAcc("登录") == -6 && cm.getBossLogAcc("第六天") == 0 ) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第六天登录奖励。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
				...
				if (cm.getSpace(1) >= 1 && cm.getPlayer().getTodayOnlineTime() >= 420 && cm.getLevel() >= 200) {
					...
					if (cm.getBossLogAcc("登录") == -7 && cm.getBossLogAcc("第七天") == 0) {
						...
						cm.worldSpouseMessage(0x20, "『彩虹七天乐』 : 恭喜 " + cm.getChar().getName() + " 成功领取第七天登录奖励获得神器一件。");
						cm.dispose();
					} else {
						cm.sendOk("无法领取该礼包。\r\n1.您已经领取过该礼包。\r\n2.您应该领取#r#e第"+(cm.getBossLogAcc("登录")*-1)+"天#n#k礼包。");
						cm.dispose();
