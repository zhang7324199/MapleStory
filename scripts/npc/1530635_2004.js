...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            } else if (cm.getJobId() >= 100 && cm.getJobId() <= 512 && cm.getBossLog("学习技能", 1) < 1) {//冒险家
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(1005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 1000 && cm.getJobId() <= 1512 && cm.getBossLog("学习技能", 1) < 1) {//骑士团
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(10001005, 1, 1);
                cm.teachSkill(10001215, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 2100 && cm.getJobId() <= 2112 && cm.getBossLog("学习技能", 1) < 1) {//战神
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(20001005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 2200 && cm.getJobId() <= 2218 && cm.getBossLog("学习技能", 1) < 1) {//龙神
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(20011005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 3000 && cm.getJobId() <= 3512 && cm.getBossLog("学习技能", 1) < 1) {//反抗者
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(30001005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 5100 && cm.getJobId() <= 5112 && cm.getBossLog("学习技能", 1) < 1) {//米哈尔
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(50001005, 1, 1);
                cm.teachSkill(50001215, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 3600 && cm.getJobId() <= 3612 && cm.getBossLog("学习技能", 1) < 1) {//尖兵
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(30021005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 2700 && cm.getJobId() <= 2712 && cm.getBossLog("学习技能", 1) < 1) {//夜光法师
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(20041005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 2300 && cm.getJobId() <= 2312 && cm.getBossLog("学习技能", 1) < 1) {//双弩精灵
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(20021005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 2400 && cm.getJobId() <= 2412 && cm.getBossLog("学习技能", 1) < 1) {//幻影
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(20031005, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 3100 && cm.getJobId() <= 3112 && cm.getBossLog("学习技能", 1) < 1) {// 恶魔猎手
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
            ...
            if (cm.getMeso() <= 99999999) {
                ...
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 6100 && cm.getJobId() <= 6112 && cm.getBossLog("学习技能", 1) < 1) {//狂龙战士
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-99999999);
                cm.teachSkill(60000190, 1, 1);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else if (cm.getJobId() >= 6500 && cm.getJobId() <= 6512 && cm.getBossLog("学习技能", 1) < 1) {//暴利萌天使
                cm.setBossLog("学习技能", 1);
                cm.gainMeso(-99999999);
            ...
            } else if (cm.getJobId() >= 1000 && cm.getJobId() <= 1512 && cm.getBossLog("学习技能", 1) < 1) {
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-5000000);
            ...
            } else if (cm.getJobId() >= 3600 && cm.getJobId() <= 3612 && cm.getBossLog("学习技能", 1) < 1) {//2100 2112
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-5000000);
                cm.sendOk("恭喜您学习技能成功,祝您游戏愉快。");
            } else {
            ...
            } else if (cm.getJobId() >= 2200 && cm.getJobId() <= 2218 && cm.getBossLog("学习技能", 1) < 1) {
                cm.setBossLog("学习技能", 1)
                cm.gainMeso(-5000000);
